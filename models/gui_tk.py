...
def pokaz_szczegoly_uzytkownika():
    ...
    label_miejscowosc_szczegoly_wartość.config(text=miejscowosc)
root=Tk()
...
label_miejscowosc_szczegoly_wartość=Label(ramka_szczegoly_obiektu, text="...",width=10)
...
label_miejscowosc_szczegoly_wartość.grid(row=1, column=7,)
